use super::transfer_verifier_circuits::{
    ...
    run_GRUMPKIN_HONK_SUMCHECK_SIZE_17_PUB_36_circuit,
};
use super::transfer_verifier_constants::{VK_HASH, precomputed_lines, vk};
...
pub mod TransferVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_17_circuit,
        run_GRUMPKIN_HONK_SUMCHECK_SIZE_17_PUB_36_circuit, vk,
    };
    ...
    impl TransferVerifierImpl of super::ITransferVerifier<ContractState> {
        fn verify_transfer_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_17_PUB_36_circuit(
