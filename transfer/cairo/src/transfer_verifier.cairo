use super::transfer_verifier_constants::{vk, precomputed_lines};
use super::transfer_verifier_circuits::{
    run_GRUMPKIN_HONK_SUMCHECK_SIZE_17_PUB_20_circuit,
    run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_17_circuit,
    run_BN254_EVAL_FN_CHALLENGE_DUPL_54P_RLC_circuit,
};

#[starknet::interface]
pub trait ITransferVerifier<TContractState> {
...
mod TransferVerifier {
    ...
    use super::{
        vk, precomputed_lines, run_GRUMPKIN_HONK_SUMCHECK_SIZE_17_PUB_20_circuit,
        run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_17_circuit,
        run_BN254_EVAL_FN_CHALLENGE_DUPL_54P_RLC_circuit,
    };
    ...
    #[abi(embed_v0)]
    impl TransferVerifierImpl of super::ITransferVerifier<ContractState> {
        fn verify_transfer_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_17_PUB_20_circuit(
            ...
            let (zk_ecip_batched_lhs) = run_BN254_EVAL_FN_CHALLENGE_DUPL_54P_RLC_circuit(
                A0: random_point,
