use scripts::constants::{
    KEY_REGISTRY_ADDRESS, USER_2_ADDRESS, USER_2_PUBLIC_KEY_X, USER_2_PUBLIC_KEY_Y,
};
...
fn main() {
    let public_key: PublicKey = PublicKey { x: USER_2_PUBLIC_KEY_X, y: USER_2_PUBLIC_KEY_Y };
    ...
    println!("Key registered for {:?}", USER_2_ADDRESS);
}
