use super::mint_verifier_constants::{vk, precomputed_lines};
use super::mint_verifier_circuits::{
    run_GRUMPKIN_HONK_SUMCHECK_SIZE_15_PUB_11_circuit,
    run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_15_circuit,
    run_BN254_EVAL_FN_CHALLENGE_DUPL_52P_RLC_circuit,
};

#[starknet::interface]
pub trait IMintVerifier<TContractState> {
...
pub mod MintVerifier {
    ...
    use super::{
        vk, precomputed_lines, run_GRUMPKIN_HONK_SUMCHECK_SIZE_15_PUB_11_circuit,
        run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_15_circuit,
        run_BN254_EVAL_FN_CHALLENGE_DUPL_52P_RLC_circuit,
    };
    ...
    #[abi(embed_v0)]
    impl MintVerifierImpl of super::IMintVerifier<ContractState> {
        fn verify_mint_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_15_PUB_11_circuit(
