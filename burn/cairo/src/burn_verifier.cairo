use super::burn_verifier_constants::{vk, precomputed_lines};
use super::burn_verifier_circuits::{
    run_GRUMPKIN_HONK_SUMCHECK_SIZE_16_PUB_11_circuit,
    run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_16_circuit,
    run_BN254_EVAL_FN_CHALLENGE_DUPL_53P_RLC_circuit,
};

#[starknet::interface]
pub trait IBurnVerifier<TContractState> {
...
mod BurnVerifier {
    ...
    use super::{
        vk, precomputed_lines, run_GRUMPKIN_HONK_SUMCHECK_SIZE_16_PUB_11_circuit,
        run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_16_circuit,
        run_BN254_EVAL_FN_CHALLENGE_DUPL_53P_RLC_circuit,
    };
    ...
    #[abi(embed_v0)]
    impl BurnVerifierImpl of super::IBurnVerifier<ContractState> {
        fn verify_burn_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_16_PUB_11_circuit(
